...
public class Main {
            ...
            if (choice == 0) choice = -1;
                ...
                while (choice != 0) {
                    ...
                    if (choice == 1) {
                        ...
                        System.out.println("\n[Library > Gestión de autores > Rellenado con autores 'aaaa' - 'zzzz zzzz'");
    ...
    static void add_books (Library library) { // genera Una biblioteca con sus respectivos autores
                                                //implementando...
    }
